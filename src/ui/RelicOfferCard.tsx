...
export function RelicOfferCard({ relicId, price, compact, disabled, onClick }: Props) {
  ...
  return (
    <>
      <Tip tip={relicTip(relic, relicIcon(relicId))}>
        <div
          className={`reward-card relic-offer rarity-${relic.rarity}${compact ? ' relic-offer--compact' : ''}${disabled ? ' disabled' : ''}`}
