...
export const EVENT_TUNING = {
  ...
  abandoned_camp: { searchChance: 25, trapGold: 15, restRevivePercent: 30, burnGold: 15, burnThreat: 1 },
  ...
  plague_cart: { burnGold: 15, lootGold: 30, lootFood: 20, lootLossPercent: 25, sellGold: 45, sellDays: 1 },
  hunters_lodge: { tradeGold: 20, tradeFood: 30, joinFood: 40, joinDays: 1, aloneChance: 50, aloneFood: 30, aloneLoss: 1 },
  deserter_knight: { recruitGold: 40, knights: 2, dispatchGold: 25, dispatchThreat: 1, dispatchLoss: 1 },
  forgotten_library: { sellGold: 35, sellDays: 1, studyDays: 1 },
  ...
  wandering_smith: { sharpenGold: 60, tradeGold: 30, watchGold: 10, watchDays: 1 },
...
const EVENT_LIST: EventDefinition[] = [
  {
    ...
    options: (a) => [
      ...
      },
      {
        id: 'burn',
        label: 'Burn it down',
        description: `Salvage what you can: +${a(T.abandoned_camp.burnGold)} Gold, Threat +${T.abandoned_camp.burnThreat} (the smoke is seen for miles).`,
        effects: [gold(T.abandoned_camp.burnGold), threat(T.abandoned_camp.burnThreat)],
  ...
  },
  {
    ...
    options: (a) => [
      ...
      },
      {
        id: 'sell_remedies',
        label: 'Sell remedies',
        description: `Needs a Priest. +${a(T.plague_cart.sellGold)} Gold, costs ${T.plague_cart.sellDays} day of food.`,
        requires: { unit: 'priest' },
        effects: [gold(T.plague_cart.sellGold), { kind: 'UPKEEP_DAYS', days: T.plague_cart.sellDays }],
  ...
  },
  {
    ...
    options: (a) => [
      ...
      },
      {
        id: 'dispatch',
        label: 'Dispatch him',
        description: `+${a(T.deserter_knight.dispatchGold)} Gold (his bounty), Threat -${T.deserter_knight.dispatchThreat}, but you lose ${T.deserter_knight.dispatchLoss} unit of a random stack in the fight.`,
        effects: [gold(T.deserter_knight.dispatchGold), threat(-T.deserter_knight.dispatchThreat), { kind: 'UNIT_LOSS', target: 'random_stack', count: T.deserter_knight.dispatchLoss }],
    ...
    options: (a) => [
      {
        id: 'study',
        label: 'Study',
        description: `Upgrade a card of your choice, costs ${T.forgotten_library.studyDays} day of food.`,
        effects: [{ kind: 'UPGRADE_CARD' }, { kind: 'UPKEEP_DAYS', days: T.forgotten_library.studyDays }],
      ...
      },
      {
        id: 'sell_tomes',
        label: 'Sell tomes',
        description: `+${a(T.forgotten_library.sellGold)} Gold, costs ${T.forgotten_library.sellDays} day of food.`,
        effects: [gold(T.forgotten_library.sellGold), { kind: 'UPKEEP_DAYS', days: T.forgotten_library.sellDays }],
  ...
  },
  {
    ...
    options: (a) => [
      ...
      },
      {
        id: 'watch',
        label: 'Watch',
        description: `+${a(T.wandering_smith.watchGold)} Gold for tending the bellows, costs ${T.wandering_smith.watchDays} day of food.`,
        effects: [gold(T.wandering_smith.watchGold), { kind: 'UPKEEP_DAYS', days: T.wandering_smith.watchDays }],
